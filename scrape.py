...
browser.get('https://www.linkedin.com/in/atharvabaste')
...
user_profile_url = 'https://www.linkedin.com/in/aarongolbin/recent-activity/all/'  # Change to the desired profile URL
